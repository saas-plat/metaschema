...
exports.FormView = (name, dom, viewModel, options) => {
  return createView(name, dom, viewModel, options, FormModel);
};
exports.FormListView = (name, dom, viewModel, options) => {
  return createView(name, dom, viewModel, options, FormListModel);
};
exports.TreeListView = (name, fdom, viewModel, options) => {
  return createView(name, dom, viewModel, options, TreeListModel);
};
exports.CardView = (name, dom, viewModel, options) => {
  return createView(name, dom, viewModel, options, CardModel);
};
